...
namespace DevUtilsD365.TableBuilder
{
    ...
    class TableBuilderMenu : MainMenuBase
    {
        ...
        /// </summary>
        public override string Caption => "Developer Tools - Table builder";

        private const string AddinName = "DevUtilsD365.TableBuilder";
        /// <summary>
